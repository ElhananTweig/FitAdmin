...
define( 'DB_NAME', 'u993113260_miriam' ); // החלף בשם מסד הנתונים שלך מהוסטינגר

/** Database username */
define( 'DB_USER', 'u993113260_elhanan' ); // החלף בשם המשתמש של מסד הנתונים

/** Database password */
define( 'DB_PASSWORD', 'Nani5276@' ); // החלף בסיסמת מסד הנתונים

/** Database hostname */
define( 'DB_HOST', 'localhost' ); // בדרך כלל localhost בהוסטינגר
 ...
 */
define( 'WP_HOME', 'https://miriamkryshevski.com/' ); // החלף בכתובת האתר שלך
define( 'WP_SITEURL', 'https://miriamkryshevski.com/' ); // החלף בכתובת האתר שלך

/**
 * Security settings
 */
define( 'DISALLOW_FILE_EDIT', true ); // מונע עריכת קבצים מהאדמין
define( 'WP_POST_REVISIONS', 3 ); // מגביל את כמות הגרסאות הקודמות
define( 'AUTOMATIC_UPDATER_DISABLED', false ); // מאפשר עדכונים אוטומטיים
